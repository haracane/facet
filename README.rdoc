...
Facet is a RubyGem project support tool.
 ...
 * Source code analysis with Flog
 * Code coverage analysis with RCov(SimpleCov)
 * CI report with CI::Reporter

== Supported Ruby versions and implementations
Facet should work identically on:
